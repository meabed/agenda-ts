...
* Agenda-TS is developed as a modern TypeScript continuation of the popular Agenda project, which is no longer actively maintained.
* Recognizing the gap left in the Node.js ecosystem, Agenda-TS aims to provide ongoing support and enhancements for job scheduling needs.
...
* Actively maintained by [Mohamed Meabed](https://github.com/meabed).
