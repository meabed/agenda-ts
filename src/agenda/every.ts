 ...
 */
export const every: EveryMethod = async function (this: Agenda, interval, names, data?, options?) {
  /**
  ...
  const createJobs = async <T extends JobAttributesData>(
    ...
    try {
      ...
      throw new AgendaError('Error creating one or more of the jobs');
    }
  };
