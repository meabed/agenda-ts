...
export const getJobsRepo = async function (this: Agenda, query = {}, sort = {}, limit = 0, skip = 0) {
 ...
 */
export const jobs: JobsMethod = async function (this: Agenda, query = {}, sort = {}, limit = 0, skip = 0) {
